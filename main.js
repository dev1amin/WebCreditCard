const cardNumber = document.getElementById("num0");
const numberInp = document.getElementById("number");
const nameInp = document.getElementById("name");
const cardName = document.getElementById("nome0");
const cardMonth = document.getElementById("mes0");
const cardYear = document.getElementById("ano0");
const monthInp = document.getElementById("data");
const yearInp = document.getElementById("dataa");
const cardCvc = document.getElementById("cvc0");
...
const content = document.querySelector(".centro")
